 ...
 */
package com.example.hrca.ocrtest.api.translate;

import java.net.URL;
import java.net.URLEncoder;

import com.example.hrca.ocrtest.api.*;

/**
 * Makes calls to the Yandex machine translation web service API
 */
public final class Translate2 extends YandexTranslatorAPI {
...
//      String translation = Translate2.execute("The quick brown fox jumps over the lazy dog.", Language.ENGLISH, Language.SPANISH);
